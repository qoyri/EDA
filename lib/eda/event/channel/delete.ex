defmodule EDA.Event.ChannelDelete do
  @moduledoc """
  Sent when a channel is deleted. Delivers an `EDA.Channel`, not a struct of its own.

  The consumer receives `{:CHANNEL_DELETE, %EDA.Channel{}}`, with every field Discord sent — including
  ...
  @doc "Parses the `CHANNEL_DELETE` payload into an `EDA.Channel`."
