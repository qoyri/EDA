defmodule EDA.Cache.Adapter do
  ...
  That split is deliberate. A backend only has to answer "where does this live"; it never
  reimplements admission filtering or memory bounds, because those sit **above** it. Every
  adapter — including one you write yourself — inherits them for free.
